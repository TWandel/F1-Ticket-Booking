            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            <span>€300.00 - €600.00</span>
                        </div>
                        <p class="lead">The 2021 Netherlands Grand Prix is scheduled to take place from September 03 to September 05. Prices are per person and valid for the entire race weekend.</p>
                        <div class="d-flex">
                        @auth
                        <select class="form-select" aria-label="Options">
                        <option selected>Choose category</option>
                        <option value="300">Bronze - €300</option>
                        <option value="450">Silver - €450</option>
                        <option value="600">Gold - €600</option>
                        </select>
                        <br>
